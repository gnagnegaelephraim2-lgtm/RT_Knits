// ============================================================
// RT KNITS — NITA CMMS Internationalization Module
// ============================================================

import type { I18NTranslations, TranslationKey } from './types';
...
const translations: I18NTranslations = {
  en: {
    ...
    phone_placeholder: "+230 5XXX XXXX", pin_placeholder: "Enter your PIN",
    ...
    conv_subtitle: "View all WhatsApp & App conversations",
    conv_search: "Search conversations...",
    conv_filter_all: "All",
    conv_filter_operators: "Operators",
    conv_filter_technicians: "Technicians",
    conv_filter_coordinators: "Coordinators",
    conv_no_messages: "No conversations found",
    conv_select_thread: "Select a conversation",
    conv_empty_thread: "Select a conversation from the list to view messages",
    conv_inbound: "Inbound",
    conv_outbound: "Outbound",
    conv_message_count: "messages",
    conv_thread_sub: "Messages from this conversation",
  ...
  fr: {
    ...
    phone_placeholder: "+230 5XXX XXXX", pin_placeholder: "Entrez votre PIN",
    ...
    nav_conversations: "Conversations",
    conv_title: "Conversations",
    conv_subtitle: "Voir toutes les conversations WhatsApp & App",
    conv_search: "Rechercher...",
    conv_filter_all: "Tous",
    conv_filter_operators: "Opérateurs",
    conv_filter_technicians: "Techniciens",
    conv_filter_coordinators: "Coordinateurs",
    conv_no_messages: "Aucune conversation trouvée",
    conv_select_thread: "Sélectionner une conversation",
    conv_empty_thread: "Sélectionnez une conversation pour voir les messages",
    conv_inbound: "Entrant",
    conv_outbound: "Sortant",
    conv_message_count: "messages",
    conv_thread_sub: "Messages de cette conversation",
  ...
  cr: {
    ...
    phone_placeholder: "+230 5XXX XXXX", pin_placeholder: "Ékrir PIN",
    ...
    nav_conversations: "Konvèsasion",
    conv_title: "Konvèsasion",
    conv_subtitle: "Gad sé tout konvèsasion WhatsApp ék App",
    conv_search: "Chérché konvèsasion...",
    conv_filter_all: "Tout",
    conv_filter_operators: "Operatér",
    conv_filter_technicians: "Tésinisyen",
    conv_filter_coordinators: "Koordinator",
    conv_no_messages: "Pé konvèsasion Trouvé",
    conv_select_thread: "Séléktyon én konvèsasion",
    conv_empty_thread: "Séléktyon én konvèsasion pou gad méssaz",
    conv_inbound: "Antré",
    conv_outbound: "Anviyé",
    conv_message_count: "méssaz",
    conv_thread_sub: "Méssaz konvèsasion sa",
  ...
  hi: {
    ...
    phone_placeholder: "+230 5XXX XXXX", pin_placeholder: "पिन दर्ज करें",
    ...
    nav_conversations: "बातचीत",
    conv_title: "बातचीत",
    conv_subtitle: "सभी WhatsApp और ऐप बातचीत देखें",
    conv_search: "बातचीत खोजें...",
    conv_filter_all: "सभी",
    conv_filter_operators: "ऑपरेटर",
    conv_filter_technicians: "तकनीशियन",
    conv_filter_coordinators: "समन्वयक",
    conv_no_messages: "कोई बातचीत नहीं मिली",
    conv_select_thread: "बातचीत चुनें",
    conv_empty_thread: "संदेश देखने के लिए सूची में से बातचीत चुनें",
    conv_inbound: "आने वाला",
    conv_outbound: "जाने वाला",
    conv_message_count: "संदेश",
    conv_thread_sub: "इस बातचीत के संदेश",
...
class NitaI18N {
  ...
  constructor() {
    this.currentLang = localStorage.getItem('nita_lang') || 'en';
    this.translations = translations;
  }

  t(key: TranslationKey): string {
    const lang = this.translations[this.currentLang as keyof I18NTranslations];
    return (lang && lang[key]) || (this.translations.en && this.translations.en[key]) || key;
  }

  setLang(lang: string): void {
    if (this.translations[lang as keyof I18NTranslations]) {
...
export const NITA_I18N = new NitaI18N();
